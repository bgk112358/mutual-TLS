...
// #define CA_CERT_FILE "./pem/abnormal/rootca.crt"
// #define INTERMEDIATE_CERT_FILE "./pem/abnormal/server_cert_chain.crt"
// #define CERT_FILE "./pem/abnormal/server.crt"
// #define KEY_FILE "./pem/abnormal/server.key"

#define CA_CERT_FILE "./pem/abnormal2/rootca.crt"
#define INTERMEDIATE_CERT_FILE "./pem/abnormal2/server_cert_chain.crt"
#define CERT_FILE "./pem/abnormal2/server.crt"
#define KEY_FILE "./pem/abnormal2/server.key"


// #define CA_CERT_FILE "./pem/normal2/rootCA.cer"
// #define INTERMEDIATE_CERT_FILE "./pem/normal2/server_cert_chain.cer"
// #define CERT_FILE "./pem/normal2/serverCA.cer"
// #define KEY_FILE "./pem/normal2/serverCA.key"
...
int main(int argc, char **argv) 
{
    ...
    // X509_VERIFY_PARAM_set_depth(param, 1);  // 设置验证深度为1，允许一级证书
    ...
    if (SSL_CTX_use_certificate_chain_file(ctx, INTERMEDIATE_CERT_FILE) <= 0) {
        ERR_print_errors_fp(stdout);
        exit(1);
    }
	...
	if (rc == -1) {
		...
		printf("SSL 连接失败! errno =%d, t_Error = %d \n", errno, err);
